        ...
        LoginResponse: {
          ...
          properties: {
            accessToken: {
              type: "string",
              description:
                "JWT access token. В Swagger UI это значение будет реальным после выполнения Try it out на /api/auth/login.",
            },
            refreshToken: {
              type: "string",
              description:
                "JWT refresh token. В Swagger UI это значение будет реальным после выполнения Try it out на /api/auth/login.",
            },
          },
        },
        RefreshResponse: {
          ...
          properties: {
            accessToken: {
              type: "string",
              description:
                "New JWT access token generated by /api/auth/refresh.",
            },
            refreshToken: {
              type: "string",
              description:
                "New JWT refresh token generated by /api/auth/refresh. Previous refresh token becomes invalid.",
            },
          },
        },
        Product: {
 ...
 *     tags: [Auth]
 *     summary: Login
 *     description: Returns JWT tokens pair. Use accessToken in Swagger Authorize as `Bearer <accessToken>`.
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *     description: Provide refreshToken in Authorization header as `Bearer <refreshToken>`. Old refreshToken becomes invalid after use.
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
 ...
 *       401:
 *         description: Invalid/expired/used refresh token
 */
